...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
        ...
        Route::post('/broadcasting/auth', fn (\Illuminate\Http\Request $request) => \Illuminate\Support\Facades\Broadcast::auth($request));
        ...
        Route::get('/auth/subscription-check', fn () => response()->json(['ok' => true]))->middleware('subscription.active');
        ...
        Route::middleware('subscription.active')->group(function () {
            ...
            Route::middleware('role:company_admin|dispatcher')->group(function () {
                ...
                Route::post('drivers/{driver}/documents', [DriverDocumentController::class, 'store'])->middleware('throttle:uploads');
                Route::put('driver-documents/{driverDocument}', [DriverDocumentController::class, 'update'])->middleware('throttle:uploads');
                ...
                Route::put('fuel-entries/{fuelEntry}', [FuelEntryController::class, 'update'])->middleware('throttle:uploads');
                ...
                Route::middleware('throttle:reports')->group(function () {
                    ...
                    Route::post('reports/queue-export', [ReportController::class, 'queueExport']);
                });
            });
            ...
            Route::middleware('role:company_admin|dispatcher|driver')->group(function () {
                ...
                Route::get('journeys/{journey}/vehicle-documents', [JourneyController::class, 'vehicleDocuments']);
